...
/// </summary>
public sealed partial class HomeMenuPage : Page
{
    public HomeMenuPage()
    {
        InitializeComponent();
    ...
    {
        Frame.Navigate(typeof(NewTestPage));
    }
    
    private void AllTestsButton_Click(object sender, RoutedEventArgs e)
    {
        Frame.Navigate(typeof(TestListPage));
    }

    private void SectionsListButton_Click(object sender, RoutedEventArgs e)
    {
